...
import { ReactComponent as BlackRightArrow } from 'assets/landingPageAssets/blackRightArrow.svg'
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className={`${style.featureDesc}`}>
                                    No auto-correction, simulating exam
                                    conditions.
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        >
                            ...
                            <div className="flex gap-1">
                                <div className={`${style.featureNumber}`}>
                                    01.
                                </div>
                                <div className={`${style.featureDesc}`}>
    ...
    const FirstSection = () => (
        <div className={`${style.hero} flex flex-col gap-16`}>
            ...
            <div className="flex flex-col gap-3 items-center">
                ...
                >
                    Experience a distraction-free writing environment and
                    receive actionable feedback on your writing.
                </motion.div>
                <motion.div
                    variants={basicVariants}
                    initial={'start'}
