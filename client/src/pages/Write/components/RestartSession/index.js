        ...
        >
            <div className="flex flex-col gap-3">
                <Item
                    ...
                    onOptionClick={() =>
                        onOptionClick(ActionTypes.RESTART_TIMER)
                    }
                />
                <Item
                    icon={<SwitchTopic />}
                    title={'Switch Topic'}
                    desc={`Generate a new topic within the same ${localStorage.getItem(
                        'category'
                    )} category.`}
                    onOptionClick={() =>
                        onOptionClick(ActionTypes.SWITCH_TOPIC)
                    }
                />
                <Item
                    icon={<ChangeCategory />}
                    ...
                    onOptionClick={() =>
                        onOptionClick(ActionTypes.CHANGE_CATEGORY)
                    }
                />
            </div>
        </div>
    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <div
                    className={`${
                        viewRestartOptions ? 'font-bold' : 'font-semibold'
                    }`}
                >
                    Restart
                </div>
