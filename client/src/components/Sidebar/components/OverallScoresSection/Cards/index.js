        ...
        >
            <div className="flex justify-between w-full cursor-pointer">
                <div>
                    <div className="flex items-baseline">
                        <span className={style.score}>5.5</span>
            ...
            {expanded && (
                <div className={`${style.expandablePart} mt-3`}>
                    You can observe that there are some XML tags like path,
                    circle, polygon, etc.. There you can add your own color with
                    help of the style attribute. Look at the below example
                </div>
            )}
        </div>
    )
